...
function VideoChatApp(props) {
  ...
  if (stream) {
    UserVideo = (
      <Video playsInline muted ref={userVideo} autoPlay style={{ width: "20%", height: "20%", position: 'absolute', top: "30" }} /> //style={{ width: "20%", height: "20%", position: "absolute", top: "0px", right: "20px", borderRadius: "12px", border: "none" }}
    );
  }
  ...
  if (callAccepted) {
    mainView = (
      <Video playsInline ref={partnerVideo} autoPlay /> //style={{ width: "70%", height: "70%", borderRadius: "12px" }}
    );
