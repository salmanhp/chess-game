...
const ChessGameWrapper = (props) => {
    ...
    // const domainName = 'https://46de-118-185-190-51.ngrok.io'
    ...
    return (
        <React.Fragment>
            {opponentDidJoinTheGame ? (
                <div>
                    <h4 style={{ marginLeft: "100px" }}> Opponent: {opponentUserName} </h4>
                    ...
                    <h4 style={{ marginLeft: "100px" }}> You: {props.myUserName} </h4>
                </div>
